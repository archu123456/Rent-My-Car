...
$sql2="INSERT INTO postcar(Name , Brand ,Overview, Rupees ,Modelyear,Image1) VALUES ('$vname','$brandname','$detail','$total','$year','$vimage1')";
...
<form method="post" class="form-horizontal" action="postcar.php" enctype="multipart/form-data">
...
<option value="Honda">Honda</option>
		...
		<option value="Yahama">Ford</option>
</select>
</div>
</div>
