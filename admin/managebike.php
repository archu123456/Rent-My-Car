...
$queryy=mysqli_query($conn,"select Id,Name,Brand,Rupees,Modelyear from postcar ");
if(isset($_REQUEST['del']))
{
	$del=$_REQUEST['del'];
	$sql=mysqli_query($conn,"delete from postcar where Id='$del'");
	$result=mysqli_query($sql);
	header("location:http://localhost:8080/project/admin/managebike.php");
}
?>
